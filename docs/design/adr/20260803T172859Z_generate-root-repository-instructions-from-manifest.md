...
- [The philosophy](../philosophy.md), [the supported targets guide](../../guide/support.md), and [the generated output guide](../../guide/generated-output.md) currently state that `AGENTS.md` is out of scope and that generated output lives in uncommitted target directories; they are updated by the pull requests that implement this decision, together with the committed-root-file exception.
